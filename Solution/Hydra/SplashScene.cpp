...
CSplashScene::InitialiseSprite()
{
	...
	/*CVector3 vecPos(static_cast<float>(kuiWindowWidth / 2),
					static_cast<float>(kuiWindowHeight / 2), 0.0f);

	m_pRenderer->GetSpriteManager().SetPosition(vecPos, m_uiSpriteMediaDesign);*/

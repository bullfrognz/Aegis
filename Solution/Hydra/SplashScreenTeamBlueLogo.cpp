...
CSplashSceneTeamBlue::CSplashSceneTeamBlue()
...
bool
CSplashSceneTeamBlue::InitialiseScene(CD3DRenderer* _pRenderer, void* _pSceneData)
{
	InitialiseSprite();
...
void
CSplashSceneTeamBlue::ProcessScene(float _fDeltaTick)
{
...
void
CSplashSceneTeamBlue::DrawScene(CD3DRenderer* _pRenderer)
{
	m_pRenderer->GetSpriteManager().Draw();
}

void
CSplashSceneTeamBlue::Alpha()
{
	...
	pRenderer->GetSpriteManager().SetModulate(uiFinalColour, m_uiTeamBlueLogo);

}


void
CSplashSceneTeamBlue::Finish()
{
	...
	rGameWindow.SetMainScene(SCENE_MAINMENU);
}

void
CSplashSceneTeamBlue::HandleDMouseInput(EDInputMouse _eDMouse, bool _bDown, long _lValue)
{
	//Empty
}

void
CSplashSceneTeamBlue::HandleDKeyboardInput(EDInputKeyboard _eDKebyoard, bool _bDown)
{
	switch (_eDKebyoard)
	{
...
void
CSplashSceneTeamBlue::HandleXButtonInput(EXInputButton _eXButton, bool _bDown)
{
	switch (_eXButton)
	{
...
bool
CSplashSceneTeamBlue::InitialiseLights(CD3DRenderer* _pRenderer)
{
...
bool
CSplashSceneTeamBlue::InitialiseViewports(CD3DRenderer* _pRenderer)
{
...
bool
CSplashSceneTeamBlue::InitialiseSprite()
{
	CWindow& rGameWindow = CApplication::GetInstance().GetGameWindow();
	...
	m_uiTeamBlueLogo = m_pRenderer->GetSpriteManager().AddSprite(L"Assets/Sprites/TeamBlueLogo.png");

	m_pRenderer->GetSpriteManager().SetObjectSpace(false, m_uiTeamBlueLogo);	
	m_pRenderer->GetSpriteManager().SetCenter(&CVector3(0,0,0), m_uiTeamBlueLogo);
...
void
CSplashSceneTeamBlue::Deinitialise()
{
	m_pRenderer->GetSpriteManager().RemoveSprite(m_uiTeamBlueLogo);
}
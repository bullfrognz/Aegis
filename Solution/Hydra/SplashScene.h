...
#ifndef __IGFEB11_IG500_SPLASHSCENE_H__
#define __IGFEB11_IG500_SPLASHSCENE_H__
...
class CSplashScene : public CScene, public IDMouseTarget, public IDKeyboardTarget, public IXButtonTarget
{
...
private:
	...
	CSplashScene(const CSplashScene& _krSplashScene);
	CSplashScene& operator = (const CSplashScene& _krSplashScene);
...
protected:
	...
	unsigned int m_uiSpriteMediaDesign;
